...
public class NetworkUtils {
     ...
     */
    public static boolean getMobileDataEnabled(Context applicationContext) {
        try {
            TelephonyManager tm =
    ...
    public static void setMobileDataEnabled(final boolean enabled, Context applicationContext) {
        try {
            TelephonyManager tm =
                    (TelephonyManager) applicationContext.getSystemService(Context.TELEPHONY_SERVICE);
            if (tm == null) return;
