package com.zenchn.support.widget.bottomnavigationbar;
...
public class BottomBarItem extends LinearLayout {
     ...
     * 设置未读数
     *
     * @param unreadNum 小于等于{ BottomBarItem#unreadNumThreshold}则隐藏，
     *                  大于0小于{BottomBarItem#unreadNumThreshold}则显示对应数字，
     *                  超过{BottomBarItem#unreadNumThreshold}
     *                  显示{BottomBarItem#unreadNumThreshold}+
     */
