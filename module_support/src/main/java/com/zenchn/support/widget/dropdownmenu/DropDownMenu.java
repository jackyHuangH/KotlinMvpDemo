...
public class DropDownMenu extends LinearLayout {
    ...
    //tab drawable padding
    private int iconPadding = 14;
    //遮罩颜色
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconPadding = a.getDimensionPixelOffset(R.styleable.DropDownMenu_ddmenuIconPadding, iconPadding);
    ...
    public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews, @NonNull View contentView) {
        ...
        popupMenuViews.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (AndroidKit.Dimens.getScreenHeight() * menuHeighPercent)));
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        final IconTextView tab = new IconTextView(getContext());
        tab.setSingleLine();
        ...
        tab.setIconPadding(iconPadding);
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            ...
            ((IconTextView) tabMenuView.getChildAt(current_tab_position)).setIconPadding(iconPadding);
        ...
        for (int i = 0; i < tabMenuView.getChildCount(); i = i + 2) {
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    ((IconTextView) tabMenuView.getChildAt(i)).setIconPadding(iconPadding);
