...
public class RingProgressBar extends View {
    ...
    public RingProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        textIsShow = mTypedArray.getBoolean(R.styleable.RingProgressBar_ringTextIsShow, true);
     ...
     * 设置文字颜色
     */
    public void setRingTextColor(int textColor) {
     ...
     * 设置文字的大小
     */
    public void setRingTextSize(float textSize) {
